...
describe('date-utils', () => {
  ...
  it('compares date parts and calculates day counts', () => {
    expect(compareDateParts({ year: 2024, month: 1, day: 1 }, { year: 2024, month: 1, day: 2 })).toBe(-1)
    expect(compareDateParts({ year: 2024, month: 1, day: 2 }, { year: 2024, month: 1, day: 1 })).toBe(1)
    expect(compareDateParts({ year: 2024, month: 1, day: 1 }, { year: 2024, month: 1, day: 1 })).toBe(0)
    expect(getDaysBetweenDateParts({ year: 2024, month: 1, day: 1 }, { year: 2024, month: 1, day: 10 })).toBe(9)
